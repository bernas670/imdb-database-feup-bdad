...
SELECT ('Inserting person that passed in 1999-03-06');
INSERT INTO Person VALUES(50,'Test','Person','Test Person was a nice guy.',NULL,'1928-07-26','1999-03-06',1,2);
...
INSERT INTO Released VALUES(50, '1999-03-07', 2);
SELECT ('Inserting release that of movie in 1999-03-07');
