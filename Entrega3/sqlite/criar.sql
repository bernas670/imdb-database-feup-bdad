...
CREATE TABLE Released(
	...
	contentID			INTEGER REFERENCES Content(id) ON UPDATE CASCADE ON DELETE CASCADE,
	date				DATE NOT NULL,
	countryID			INTEGER REFERENCES Country(id) ON UPDATE CASCADE ON DELETE CASCADE,
